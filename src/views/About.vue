  ...
  <div class="main h-screen">
    <div class="mainImage relative">
      ...
      <div class="absolute top-0 left-0 mt-12 ml-12 text-xl w-1/4">
        <h1 class="text-2xl mb-3">Photographe de mariage basé à Toulouse</h1>
        <p class="text-gray-700 text-base">
          ...
          <span class="text-lg my-5">Manon</span>
        </p>
      </div>
    </div>
    <div class="secondScroll h-screen w-100 flex flex-col">
      <div class="aboutAndPicture flex justify-around mt-48">
        <div class="leftSide w-1/3 h-1/2 flex flex-col justify-center">
          <h1 class="text-2xl uppercase">à propos de Franck</h1>
